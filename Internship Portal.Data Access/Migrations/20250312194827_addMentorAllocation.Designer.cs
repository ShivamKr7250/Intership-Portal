...
namespace Internship_Portal.Data_Access.Migrations
{
    ...
    [Migration("20250312194827_addMentorAllocation")]
    partial class addMentorAllocation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Internship_Portal.Model.AppliedDrive", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Internship_Portal.Model.MentorAllocation", b =>
                {
                    b.Property<int>("MentorAllocationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("MentorAllocationId"));
            ...
            modelBuilder.Entity("Internship_Portal.Model.AppliedDrive", b =>
                {
                    ...
                    b.HasOne("Internship_Portal.Model.Student", "Student")
                        .WithMany()
            ...
            modelBuilder.Entity("Internship_Portal.Model.MentorAllocation", b =>
                {
                    ...
                    b.HasOne("Internship_Portal.Model.ApplicationUser", "Mentor")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
