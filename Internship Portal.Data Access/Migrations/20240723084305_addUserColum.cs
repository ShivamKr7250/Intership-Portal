...
{
    /// <inheritdoc />
    public partial class addUserColum : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RegistrationForms_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BlogThumnail = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "SubmitedInternship",
                columns: table => new
                {
                    ID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    GitHubLink1 = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    LinkedinLink1 = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    GitHubLink2 = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    LinkedinLink2 = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    GitHubLink3 = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    LinkedinLink3 = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PaymentScreenShot = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IntenshipId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubmitedInternship", x => x.ID);
                    table.ForeignKey(
                        name: "FK_SubmitedInternship_RegistrationForms_IntenshipId",
                        column: x => x.IntenshipId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RegistrationForms_UserId",
                table: "RegistrationForms",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_SubmitedInternship_IntenshipId",
                table: "SubmitedInternship",
                column: "IntenshipId");
        }
